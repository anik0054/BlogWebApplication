<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="BlogWebApplication.UI.Search" %>
...
<%
    ...
    List<Article> articleList = articleManager.GetAllArticleBySeach(searchText);
...
<body>
    ...
    <div class="container content">
        <div class="row">
            <div class="col-md-9">
                <h1 class="page-header">Search Results for "<%=searchText %>"<small></small></h1>
                <% 
        ...
        <div class="row">
            <div class="text-center">
                <ul class="pagination">
                    ...
                    <li class="disabled"> <a class="glyphicon glyphicon-arrow-left" > Newer Posts </a> </li> 
                    <li> <a class="active"><%=page%> </a></li>
                    <li> <a href="Search.aspx?page=<%=page+1%>&searchText=<%=searchText%>"> Older Posts &nbsp;&nbsp;<span class="disabled glyphicon glyphicon-arrow-right"></span></a> </li> 
                    <%
                    }
                    else if (page == noOfPage)
                    {
                    %>
                    <li> <a class="glyphicon glyphicon-arrow-left" href="Search.aspx?page=<%=page-1%>&searchText=<%=searchText%>"> Newer Posts </a> </li> 
                    <li> <a class="active"><%=page%> </a></li>
                    <li class="disabled"> <a> Older Posts &nbsp;&nbsp;<span class="disabled glyphicon glyphicon-arrow-right"></span></a> </li> 
                    <%
                    }
