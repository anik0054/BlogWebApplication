<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArticleEntry.aspx.cs" Inherits="BlogWebApplication.UI.ArticleEntry" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container content">
            <div class="row">
                <div class="col-md-9">
                    <h1 class="page-header">Create a new article</h1>
